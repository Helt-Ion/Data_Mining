...
def data_process_payment_method_sub(data_file, part_num, category_mp):
	data_categories = []
	...
	parquet_output = os.path.join(data_file, f"data_payment_method.parquet");
